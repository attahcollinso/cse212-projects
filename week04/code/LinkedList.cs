...
public class LinkedList : IEnumerable<int>
{
    ...
    public IEnumerable Reverse()
    {
        ...
        //we can't move backward in a singly linked list, so we use the tail pointer
        Stack<int> stack = new Stack<int>();
        var curr = _head; // Start at the end since this is a backward iteration.
        while (curr != null)
        {
            stack.Push(curr.Data); // Push each item onto the stack
            curr = curr.Next; // Go backward in the linked list
        }
